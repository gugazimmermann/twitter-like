let users = {
  ...
  gugazimmermann: {
    ...
    avatarURL: "https://avatars0.githubusercontent.com/u/48167381?s=460&v=4",
...
let tweets = {
  ...
  "czpa59mg577x1oo45cup0d": {
    ...
    author: "dan_abramov",
    timestamp: 1515043995650,
    likes: ['gugazimmermann', 'sarah_edo'],
  ...
  "6h5ims9iks66d4m7kqizmv": {
    ...
    likes: ['dan_abramov', 'gugazimmermann'],
  ...
  "sfljgka8pfddbcer8nuxv": {
    ...
    likes: ['sarah_edo', 'gugazimmermann'],
    replyingTo: "hbsc73kzqi75rg7v1e0i6a",
    replies: [],
  },
